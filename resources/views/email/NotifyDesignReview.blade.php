...
<div class="container">
    ...
    <p>We are excited to inform you that a user has left a review on one of your designs on our platform. It's always rewarding to receive feedback on your creative work!</p>

    <p>
        <strong>Design Reviewed:</strong> {{$project_title}}<br>
    </p>

    <p>
        To view the review and engage with the user, you can access the design directly on our platform by clicking the link below:
        <br>
        <a href="{{ $reviewUrl }}">View Reviewed Design</a>
    </p>
